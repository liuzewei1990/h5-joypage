  ...
  export default {
    ...
    methods: {
      ...
      handleResize: function (event) {
        ...
        const { x, y } = position;
        // console.log("鼠标位置",position); // 鼠标位置 {x: 729.9322509765625, y: 642.2200317382812}
        const newSize = { width: 0, height: 0 };
        let pos;
        switch (event.type) {
          case "resizestart": {
            console.log("resizestart:--------开始");
            this.tryMakeResizable();
          ...
          case "resizemove": {
            ...
            this.resizing = newSize;
            // console.log("this.resizing:",{...this.resizing}); // this.resizing {width: 519.93408203125, height: 546.6915893554688}
            // console.log("event.rect:",event.rect);
            break;
          }
          case "resizeend": {
            console.log("resizeend:--------结束", { ...this.resizing });
        ...
        console.log("pos", pos); // pos {w: 8, h: 16}
