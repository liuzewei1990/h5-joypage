...
<script>
  ...
  import EditorSider from "./components/EditorSider/index.vue";
  ...
  import WorkEditor from "./class/work.editor.class";
  import { string, number, oneOfType, array } from "vue-types";

  export default {
    name: "work-editor",
    components: { EditorLayout, EditorHeader, EditorSider, EditorSiderDrawer, DrawerJson, EditorCanvas, PreRender },
    props: {
